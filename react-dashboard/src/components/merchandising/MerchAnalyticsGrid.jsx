...
import { ChevronRight, Package, Tag, RefreshCw, ArrowUpRight } from 'lucide-react';

const MerchAnalyticsGrid = ({
  currentItems,
  drawerProductId,
  setDrawerProductId,
  getStatusBadge,
      ...
      <table className="w-full border-collapse">
        <thead>
          <tr className="bg-slate-50">
            ...
            <th className="p-4 text-center text-[0.75rem] font-extrabold text-slate-500 border-b border-slate-200 uppercase tracking-wider w-[160px]">VIEWS ({tfLabel})</th>
            <th className="p-4 text-center text-[0.75rem] font-extrabold text-slate-500 border-b border-slate-200 uppercase tracking-wider w-[160px]">SOLD ({tfLabel})</th>
            <th className="p-4 text-center text-[0.75rem] font-extrabold text-slate-500 border-b border-slate-200 uppercase tracking-wider w-[160px]">RETURNS ({tfLabel})</th>
          </tr>
        </thead>
        <tbody>
          {currentItems.map(p => (
...
export default MerchAnalyticsGrid;
